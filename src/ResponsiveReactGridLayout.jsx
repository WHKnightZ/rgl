...
export default class ResponsiveReactGridLayout extends React.Component {
  ...
  onWidthChange(prevProps) {
    ...
    const newBreakpoint = this.props.breakpoint || getBreakpointFromWidth(this.props.breakpoints, this.props.width);
    ...
    if (lastBreakpoint !== newBreakpoint || prevProps.breakpoints !== breakpoints || prevProps.cols !== cols) {
      ...
      if (!(lastBreakpoint in newLayouts)) newLayouts[lastBreakpoint] = cloneLayout(this.state.layout);
