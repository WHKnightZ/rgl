 ...
 */
export function calcWH(positionParams, width, height, x, y, oldW, oldH, updateLeft, updateTop) {
  ...
  // Capping
  w = clamp(w, 0, cols - newX);
  h = clamp(h, 0, maxRows - newY);
